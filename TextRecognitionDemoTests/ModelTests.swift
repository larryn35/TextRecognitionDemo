...
class ModelTests: XCTestCase {
  func testParsingJSONIsWorkingForRxCui() throws {
    ...
    XCTAssertNotNil(drugID,
                    "drugID returned nil")
    
    XCTAssertEqual(drugID.id,
                   "36437",
                   "Parsed result did not return 36437 for RxCui")
  }
  ...
  func testRxCuiURLBuilder() {
    ...
    XCTAssertEqual(url?.absoluteString,
                   MockData.rxCuiURL,
                   "RxCuiURL not constructed correctly")
  }
  ...
  func testParsingJSONIsWorkingForInteractions() throws {
    ...
    XCTAssertEqual(interactions.count,
                   3,
                   "Parsed results did not return 3 for interactions count")
    ...
    XCTAssertEqual(interactions[0].description,
                   firstInteractionDescription,
                   "Parsed results did not return correct description for first interaction")
    ...
    XCTAssertEqual(interactions[2].description,
